...
<div class="flex">
    ...
    <div class="container mx-auto p-16">
        <h1 class="text-3xl font-bold mb-4 text-test">Edit Buku</h1>
        <form action="/update" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="judul_buku" value="{{ $book['judul_buku'] }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
            <div class="mb-6">
                <label class="block text-gray-700 text-xl font-semibold mb-2">Jenis Buku:</label>
                <input type="text" name="jenis_buku" value="{{ $book['jenis_buku'] }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
