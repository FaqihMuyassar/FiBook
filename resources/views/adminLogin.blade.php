                ...
                <div class=" flex flex-col gap-6 px-12 pb-24">
                    <div class="flex flex-col gap-4 mb-12">
                        <label class="input input-bordered flex items-center gap-2">
                            ...
                            <input type="text" name="username" class="grow text-xl" placeholder="Username" required>
                        </label>
                        <label class="input input-bordered flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"
                                class="h-4 w-4 opacity-70">
                            ...
                            <input type="password" name="password" class="grow text-xl" value="" placeholder="Password" required>
                        </label>
                    </div>
                    {{-- <button type="submit"
                        class="text-center w-full bg-button p-4 rounded-xl hover:bg-hoverbt hover:ease-in-out transition">
